...
| 이미지 속 일본어 | 타이틀 로고 1개 + **UI 라벨 103개** |
...
커맨드 버튼·합전 명령·무장 능력치 이름·지도 상단 상태창은 폰트가 아니라
**그림(OBJ 스프라이트)** 입니다. 103개를 원본 배경·음각·외곽선을 그대로 살려
한글로 다시 그렸습니다.

<p align="center">
  <img src="images/panel_ba.png" width="620" alt="상태창 라벨 한글화 전후">
</p>
